/* DOTYK SLOV — modular footer redesign v2 */
(function(){
  'use strict';
  var IG='https://www.instagram.com/dotykslov/';
  function $(s,r){return (r||document).querySelector(s)}
  function ensureCss(){var h='https://matuasiak.github.io/dotyk-slov-assets/css/footer-redesign.css?v=2';var l=document.querySelector('link[data-ds-footer-css]');if(l){l.href=h;return}l=document.createElement('link');l.rel='stylesheet';l.href=h;l.dataset.dsFooterCss='1';document.head.appendChild(l)}
